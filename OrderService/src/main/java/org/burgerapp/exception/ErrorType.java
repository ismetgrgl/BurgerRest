...
public enum ErrorType {
	...
	ROLE_CONTROL_FAILED(4000,"Yetkiniz yok.", HttpStatus.BAD_REQUEST),
	CATEGORY_NOT_FOUND(4001,"Kategori bulunamadı.", HttpStatus.BAD_REQUEST),
	...
	DRINKS(4002,"Bu ürüne ekstra eklenemez" ,HttpStatus.NOT_FOUND );
